...
2. Name two big differences between ```display: block;``` and ```display: inline;```.
        Display inline allows you to set the width and height, block does not. Also margins and paddings are respected in inline.
3. What are the 4 areas of the box model?
        Content edge, padding edge, border edge, margin edge.
4. While using flexbox, what axis does the following property work on: ```align-items: center```?

5. Explain why git is valuable to a team of developers.
        It allows the team to track every change and update that occurred during the project. It also allows for work to be checked by a second or third person before it is submitted to the main code.
